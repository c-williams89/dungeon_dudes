...
class Wizard(Character):
    ...
    def lightning_bolt(self) -> [bool, CombatAction]:
        ...
        if self._special >= 50:  
            ...
            lightning_bolt_action = CombatAction([("Attack", lightning_damage, "Lightning", message)], "")
    ...
    def mana_burn(self) -> [bool, CombatAction]:
        ...
        if self._special > 0:  # Check if the Wizard has any remaining mana
            # Calculate the base damage for each damage type based on 50% of consumed mana (rounded up)
