...
|Breath
|1
|Drakes breath dealing 50% their current HP + intelligence damage of their drake's damage type
...
|Cauterizing Burst
|1
|Sunfire Griffon deals damage from its damage type at a base of 1/3 current `hit_points` and heals for `hit_points` equal to its `intelligence`
...
|Hymn
|1
|Anointed Griffon deals damage from its damage type at a base of 1/3 current `hit_points` and increases its defensive mod vs `Physical` and `Holy` by 10 for the rest of the battle.
